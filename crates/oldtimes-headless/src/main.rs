...
use oldtimes_core::{data::*, save::*, SimulationApp};
...
fn run_simulation(map_name: &str, ticks: u64, record_file: Option<&str>, tps: u32) -> Result<()> {
    log::info!(
        "Starting simulation: map={}, ticks={}, tps={}",
        map_name,
        ticks,
        tps
    );
